...
A reasonable variation range is then defined for the six important inputs (Table \ref{table:reference-values}), covering the possible evolutions of the electricity system up to 2050.
