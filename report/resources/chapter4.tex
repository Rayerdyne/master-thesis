...
\begin{table}[h!]
    ...
    %     3 & 0.1 &  14 & 0.1171 & 4 & 0.4 &  14 & 0.0150 \\
    %     3 & 0.1 &  15 & 0.1050 & 4 & 0.4 &  15 & 0.0148 \\
...
% As there are tree dimensions to take into account, we need to find combination of values. Results on Table \ref{tab:results-xgboost} indicate that there is a balance to find between the depth of the approximators and their number. Sh
