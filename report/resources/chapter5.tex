...
Vensim provides a variety of tools to describe models, but at the end every model is an interconnection of variables, the math hiding in the connections between these. \mywarning{Split here into Vensim overview and Vensim models ?}
