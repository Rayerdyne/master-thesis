...
The Dispa-SET model \cite{dispaset} is described in \cite{dispaset2} as "an open-source unit commitment and optimal dispatch model focused on the balancing and flexibility problems in European grids".
